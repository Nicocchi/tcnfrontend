...
export default function ArticleBox(props) {
    ...
    return (
        <div className="article-box-wrapper">
            <Link
                style={{ color: "#000" }}
                to={`/police-reports/${yyyy}/${mmd}/${dd}/${props.article.fields.title.replace(/ /g, "-")}/#id=${props.article.sys.id}`}
            >
            ...
            <Link to={`/police-reports/${yyyy}/${mmd}/${dd}/${props.article.fields.title.replace(/ /g, "-")}/#id=${props.article.sys.id}`}>
