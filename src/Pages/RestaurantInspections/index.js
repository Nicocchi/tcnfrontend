...
export default class RestaurantInspections extends Component {
    constructor(props) {
        super(props);
        this.state = {
            articles: null,
        ...
        client
            ...
            .then((response) => {
                ...
                response.items.forEach((entry, index) => {
                    if (entry.sys.contentType.sys.id === "restaurantInspections") articles.push(entry);
                });
...
// RestaurantInspections.propTypes = {
